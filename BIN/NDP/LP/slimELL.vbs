...
Function ProcessMSI(file)
	...
	QueryDatabase("DELETE FROM `FeatureComponents` WHERE `Feature_` = 'MSICache_FullLP_amd64_ell'") 
	QueryDatabase("DELETE FROM `FeatureComponents` WHERE `Feature_` = 'MSICache_FullLP_x86_ell'") 
	...
	QueryDatabase("DELETE FROM `Feature` WHERE `Feature` = 'MSICache_FullLP_amd64_ell'") 
	QueryDatabase("DELETE FROM `Feature` WHERE `Feature` = 'MSICache_FullLP_x86_ell'") 
	...
	QueryDatabase("DELETE FROM `File` WHERE `Component_` = 'Installer_MSICache_FullLP_amd64_ell'") 
	QueryDatabase("DELETE FROM `File` WHERE `Component_` = 'Installer_MSICache_FullLP_x86_ell'") 
	...
	QueryDatabase("DELETE FROM `Registry` WHERE `Component_` = 'Identity_RegEntries_amd64_ell_FullLP'") 
	QueryDatabase("DELETE FROM `Registry` WHERE `Component_` = 'Identity_RegEntries_x86_ell_FullLP'") 
