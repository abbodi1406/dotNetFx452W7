...
Function ProcessMSI(file)
	...
	QueryDatabase("DELETE FROM `FeatureComponents` WHERE `Feature_` = 'MSICache_FullLP_amd64_fra'") 
	QueryDatabase("DELETE FROM `FeatureComponents` WHERE `Feature_` = 'MSICache_FullLP_x86_fra'") 
	...
	QueryDatabase("DELETE FROM `Feature` WHERE `Feature` = 'MSICache_FullLP_amd64_fra'") 
	QueryDatabase("DELETE FROM `Feature` WHERE `Feature` = 'MSICache_FullLP_x86_fra'") 
	...
	QueryDatabase("DELETE FROM `File` WHERE `Component_` = 'Installer_MSICache_FullLP_amd64_fra'") 
	QueryDatabase("DELETE FROM `File` WHERE `Component_` = 'Installer_MSICache_FullLP_x86_fra'") 
	...
	QueryDatabase("DELETE FROM `Registry` WHERE `Component_` = 'Identity_RegEntries_amd64_fra_FullLP'") 
	QueryDatabase("DELETE FROM `Registry` WHERE `Component_` = 'Identity_RegEntries_x86_fra_FullLP'") 
